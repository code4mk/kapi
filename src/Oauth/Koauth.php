...
class Koauth
{
  ...
  public function appInfo(){
    // check api app
    $appInfo = ApiModel::where('key',\Request::get(Config::get('kapi.app.key') ? Config::get('kapi.app.key') : 'kapi_key'))
                          ->where('secret',\Request::get(Config::get('kapi.app.secret') ? Config::get('kapi.app.secret') : 'kapi_secret'))
                          ->where('block',false)
                          ->where('active',true)
                          ->where(function ($query){
                            if (Config::get('kapi.approval')) {
